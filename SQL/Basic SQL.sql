...
INSERT INTO sakila.payment_type (type) VALUES 
('Credit Card'),
('Cash'),
('Paypal'),
('Cheque');
...
SELECT (12 / rental_duration) * rental_rate as rental_cost 
FROM sakila.film 
